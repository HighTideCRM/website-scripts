    ...
    if (validate_form()) {
      ...
      async function submitForm() {
        ...
        const response = await fetch(
          "https://vinylmarketing40840.activehosted.com/proc.php?jsonp=true",
          {
            headers: {
      ...
      if (formSupportsPost) {
        ...
        _load_script(
          "https://vinylmarketing40840.activehosted.com/proc.php?" +
            serialized +
            "&jsonp=true",
          null,
          true
      ...
      window.location.replace(
        "https://calendly.com/d/3yn-2gv-mwn/hightide-demo?email=" +
          formData.get("email")
      );
    }
    return false;
